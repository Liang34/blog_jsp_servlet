...
<body>
    ...
    <div class="content">
        ...
        <div class="main">
            ...
            <!-- /分类标题 -->
            <form class="form-container" action='/blog_JSP_Servlet/ArticleChange' method='post' enctype = 'multipart/form-data'>
                ...
                <div class="form-group">
                    <label>作者</label>
                    <input type="text" class="form-control" readonly name='author' value=${ article.username }>
                </div>
                <div class="form-group">
                    <label>发布时间</label>
                    <input type="date" class="form-control" name='pubDate' value=${ article.pubDate }>
                </div>
                ...
                <div class="form-group">
                    <label>内容</label>
                    <textarea class="form-control" id="editor" name='content' value=${ article.content }></textarea>
                </div>
                <div class="buttons">
